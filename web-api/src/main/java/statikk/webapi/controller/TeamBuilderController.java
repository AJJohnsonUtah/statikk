...
public class TeamBuilderController extends BaseController {
    ...
    public TeamBuilderSuggestion getSuggestions(@RequestBody TeamBuilderProgressData teamBuilderProgess) {
        return teamBuilderService.getTeamBuilderSuggestion(teamBuilderProgess);
    }
}
