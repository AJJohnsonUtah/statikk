...
public class ChampionWinRateController {
    ...
    public WinRateWithTotal<ChampionWinRate> getAllChampionWinRates(@RequestParam("matchType") int matchType) {
        return new WinRateWithTotal(championWinRateService.getChampionWinRates(QueueType.fromId(matchType)));
    }
}
