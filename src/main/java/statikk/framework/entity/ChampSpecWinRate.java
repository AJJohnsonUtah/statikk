...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ChampSpecWinRate.findAllGrouped", query = "SELECT NEW statikk.framework.stats.model.ChampionWinRate(c.champSpecWinRatePK.champSpec.championId, SUM(c.playedCount), SUM(c.winCount)) FROM ChampSpecWinRate c GROUP BY c.champSpecWinRatePK.champSpec.championId"),
